            ...
            <ul class="nav ace-nav">
                ...
                <li class="green">
                    ...
                    <ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                        ...
                        <li>
                            <a href="#">
                                <img src="${ctxStatic}/js/common/avatars/avatar.png" class="msg-photo"
                                     alt="Alex's Avatar"/>
                                <span class="msg-body">
                        ...
                        <li>
                            <a href="#">
                                <img src="${ctxStatic}/js/common/avatars/avatar3.png" class="msg-photo"
                                     alt="Susan's Avatar"/>
                                <span class="msg-body">
											<span class="msg-title">
                        ...
                        <li>
                            <a href="#">
                                <img src="${ctxStatic}/js/common/avatars/avatar4.png" class="msg-photo"
                                     alt="Bob's Avatar"/>
                                <span class="msg-body">
											<span class="msg-title">
                ...
                <li class="light-blue">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <img class="nav-user-photo" src="${ctxStatic}/js/common/avatars/user.jpg" alt="Jason's Photo"/>
                    ...
                    <ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                        ...
                        <li>
                            <a href="${ctx}/login/user/loginOut">
                                <i class="icon-off"></i>
                                退出
                            </a>
                        </li>
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
                ...
                <li>
                    ...
                    <ul class="submenu">
                        <li>
                            <a href="${ctx}/bootstrap/user/profile">
                                <i class="icon-double-angle-right"></i>
                                用户信息
                            </a>
                        </li>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Bob Doe's avatar"
                                                                     src="${ctxStatic}/js/common/avatars/user.jpg"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Joe Doe's avatar"
                                                                     src="${ctxStatic}/js/common/avatars/avatar2.png"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Jim Doe's avatar"
                                                                     src="${ctxStatic}/js/common/avatars/avatar.png"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Alex Doe's avatar"
                                                                     src="${ctxStatic}/js/common/avatars/avatar5.png"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Susan's avatar"
                                                                     src="${ctxStatic}/js/common/avatars/avatar3.png"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Phil Doe's avatar"
                                                                     src="${ctxStatic}/js/common/avatars/avatar4.png"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Alexa Doe's avatar"
                                                                     src="${ctxStatic}/js/common/avatars/avatar1.png"/>
                                                            </div>
...
<script type="text/javascript">
    window.jQuery || document.write("<script src='${ctxStatic}/js/common/js/jquery-2.0.3.min.js'>" + "<" + "script>");
</script>
...
<!--[if IE]>
<script type="text/javascript">
    window.jQuery || document.write("<script src='${ctxStatic}/js/common/js/jquery-1.10.2.min.js'>" + "<" + "script>");
</script>
<![endif]-->

<script type="text/javascript">
    if ("ontouchend" in document) document.write("<script src='${ctxStatic}/js/common/js/jquery.mobile.custom.min.js'>" + "<" + "script>");
</script>
<script src="${ctxStatic}/js/common/js/bootstrap.min.js"></script>
<script src="${ctxStatic}/js/common/js/typeahead-bs2.min.js"></script>

<!-- page specific plugin scripts -->

<!--[if lte IE 8]>
<script src="${ctxStatic}/js/common/js/excanvas.min.js"></script>
<![endif]-->

<script src="${ctxStatic}/js/common/js/jquery-ui-1.10.3.custom.min.js"></script>
<script src="${ctxStatic}/js/common/js/jquery.ui.touch-punch.min.js"></script>
<script src="${ctxStatic}/js/common/js/jquery.slimscroll.min.js"></script>
<script src="${ctxStatic}/js/common/js/jquery.easy-pie-chart.min.js"></script>
<script src="${ctxStatic}/js/common/js/jquery.sparkline.min.js"></script>
<script src="${ctxStatic}/js/common/js/flot/jquery.flot.min.js"></script>
<script src="${ctxStatic}/js/common/js/flot/jquery.flot.pie.min.js"></script>
<script src="${ctxStatic}/js/common/js/flot/jquery.flot.resize.min.js"></script>

<!-- ace scripts -->

<script src="${ctxStatic}/js/common/js/ace-elements.min.js"></script>
<script src="${ctxStatic}/js/common/js/ace.min.js"></script>
